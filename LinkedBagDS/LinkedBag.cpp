...
template<class ItemType>
LinkedBag<ItemType>& LinkedBag<ItemType>::operator=(const LinkedBag<ItemType>& other) {
    if (this == &other) {
        return *this;
    }
	this->clear();
	...
	if (other.headPtr != nullptr) {
		...
		headPtr = new Node<ItemType>();
		headPtr->setItem(other.headPtr->getItem());

		
		Node<ItemType>* currentOther = other.headPtr->getNext();
		Node<ItemType>* currentNew = headPtr;

		
		while (currentOther != nullptr) {
			
			Node<ItemType>* newNode = new Node<ItemType>();
			newNode->setItem(currentOther->getItem());
